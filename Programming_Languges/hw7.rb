...
# as described in the assignment
  ...
  class Point < GeometryValue
    ...
    private
    def real_close_point other
      real_close(@x, other.x) && real_close(@y, other.y)
    end
    def in_between(x, end1, end2)
      (end1 - GeometryExpression::Epsilon <= x &&
       x <= end2 + GeometryExpression::Epsilon) ||
      (end2 - GeometryExpression::Epsilon <= x &&
       x <= end1 + GeometryExpression::Epsilon)
    end
  end
